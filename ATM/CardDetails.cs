...
namespace ATM
{
    class CardDetails
    {
        //protected string[,] cardDetails = { { "1234567890", "1234" }, { "2468101214", "1793" }, { "3691215182", "7539" }, { "4812162024", "9517" } };
...

        {
            ...
            checkFiles(cardDetails);

            //obj.searchCard(cardNumber, cardDetails);

            if (!(searchCard(cardNumber, cardDetails)))
            {
            ...
            else
            {
                ...
                if (!(validPIN(pin(cardNumber, cardDetails), pinNumber)))
                {
                ...
                else
                {
                    ...
                    customerSelection(selectionInt, cardNumber);
                }
